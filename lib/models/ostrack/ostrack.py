...
from lib.models.ostrack.vit_ce_adapter_modal import  vit_base_patch16_224_ce_adapter_modal
...
def build_ostrack(cfg, training=True):
    ...
    elif cfg.MODEL.BACKBONE.TYPE == 'vit_ce_adapter':
    ...
    elif cfg.MODEL.BACKBONE.TYPE == 'vit_ce_adapter_modal':
        backbone = vit_base_patch16_224_ce_adapter_modal(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
                                           ce_loc=cfg.MODEL.BACKBONE.CE_LOC,
                                           ce_keep_ratio=cfg.MODEL.BACKBONE.CE_KEEP_RATIO,
                                           )
        hidden_dim = backbone.embed_dim
