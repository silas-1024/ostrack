...
dataset_dict = dict(
    ...
    sv248s_test=DatasetInfo(module=pt % "sv248s_test_", class_name="sv248s_test_dataset", kwargs=dict()),
    sv248s_test_modal=DatasetInfo(module=pt % "sv248s_test_modal_", class_name="sv248s_test_modal_dataset", kwargs=dict()),
