...
def local_env_settings():
    ...
    settings.network_path = '/media/lisuran/ostrack/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/data/sot/data/nfs'
    settings.otb_path = '/data/sot/data/otb'
    settings.prj_dir = '/media/lisuran/ostrack'
    settings.result_plot_path = '/media/lisuran/OSTrack _sv/output/test/result_plots'
    settings.results_path = '/media/lisuran/ostrack/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/media/lisuran/ostrack/output'
    settings.segmentation_path = '/media/lisuran/ostrack/output/test/segmentation_results'
