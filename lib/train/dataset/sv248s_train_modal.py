...
class SV248S_TRAIN_MODAL(BaseVideoDataset):
    ...
    def __init__(self, root=None, dtype='rgbrgb', seq_ids=None, data_fraction=None):
        ...
        super().__init__('SV248S_TRAIN_MODAL', root)
        self.dtype = dtype
    ...
    def _read_bb_anno(self, seq_path):
        ...
        rgb_bb_anno_file = os.path.join(seq_path, "groundTruth.rect")
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        rgb_frame_path = os.path.join(seq_path, 'sequences', '{:06}.tiff'.format(frame_id+1))  # frames start from 0
        ir_frame_path = os.path.join(seq_path, 'frame_diff', '{:06d}.jpg'.format(frame_id+1))
