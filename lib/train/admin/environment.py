...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'lasot_dir': empty_str,
        'sv248s_train_dir': empty_str,
        'sv248s_train_modal_dir': empty_str,
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'sv248s_train_dir': os.path.join(data_dir,'sv248s_train'),
        'sv248s_train_modal_dir': os.path.join(data_dir,'sv248s_train'),
